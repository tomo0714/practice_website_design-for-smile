      ...
      <div className={styles.inner}>
        ...
        <ul className={styles.post}>
          <li className={styles.post__item}>
            <time className={styles.post__date} datetime="2020-02-01">
              2020.02.01
            </time>
          ...
          <li className={styles.post__item}>
            <time className={styles.post__date} datetime="2020-01-18">
              2020.01.18
            </time>
            <a href="#!" className={styles.post__title}>
          ...
          <li className={styles.post__item}>
            <time className={styles.post__date} datetime="2020-01-01">
              2020.01.01
            </time>
            <a href="#!" className={styles.post__title}>
              新年明けましておめでとうございます
